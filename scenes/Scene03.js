...
class Scene03 extends Phaser.Scene {
    ...
    create() { 
        ...
        jacare = this.add.sprite(5740,507,'jacare').setScale(0.38);
        this.anims.create({
            key: 'pular2',
        ...
        grades = this.add.image(5740,507,'grades');
        ...
        platAuxScene = this.physics.add.staticImage(6125,290,'').setSize(50,700).setScale(0.3).setVisible(false);
        ...
        // adiciona o celular
        celular = this.physics.add.sprite(5540,500,'celular').setScale(0.5).setVisible(true);
        ...
        botaoE = this.physics.add.sprite(5557, 400, 'botaoE').setScale(0.15);
