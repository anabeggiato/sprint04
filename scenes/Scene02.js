...
class Scene02 extends Phaser.Scene{
    ...
    create(){
        ...
        platAux = this.physics.add.staticImage(12600,290,'').setSize(50,700).setScale(0.3).setVisible(false);
       ...
       chaoG = this.physics.add.staticImage(12300,600,'chao2').setSize(900, 30).setScale(3.5,1);
        ...
        pregador15 = this.physics.add.staticImage(10700,400,'pregador').setSize(220,50).setScale(0.8);
        this.physics.add.collider(player, pregador15, () => {
            playernoChao = true;
        });


        pregador16 = this.physics.add.staticImage(10700,650,'pregador').setSize(220,50).setScale(0.8);
    ...
    update(){
     ...
     //   portal.anims.play('mexer', true);
       // portal.setMaxVelocity (0);
        ...
        //depois de 2s que o "Q" foi pressionado, o HUD de links aparece
